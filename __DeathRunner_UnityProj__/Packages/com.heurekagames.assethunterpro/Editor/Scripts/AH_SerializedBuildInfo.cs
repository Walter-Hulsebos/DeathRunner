...
namespace HeurekaGames.AssetHunterPRO
{
    ...
    public class AH_SerializedBuildInfo
    {
        ...
        private Dictionary<string, List<string>> assetDict = new Dictionary<string, List<string>>();
        ...
        private SortedList<string, AH_SerializableAssetInfo> assetListSorted = new SortedList<string, AH_SerializableAssetInfo>();

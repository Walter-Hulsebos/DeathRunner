...
namespace ProjectDawn.Collections
{
    ...
    /// It is implemented using heap. Peek = O(1), Enqueue = O(Log n), Dequeue = O(Log 1).
    /// </summary>
    ...
    [Obsolete("This structure is obsolete from 1.7, please use either NativeLinkedPriorityQueue or NativeHeapPriorityQueue")]

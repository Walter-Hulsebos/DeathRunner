...
namespace ProjectDawn.Collections
{
        ...
        where T : unmanaged, ISurfaceArea<T>, IUnion<T>
    {
        ...
        public float GetBalancedTreeFactor()
        {
            ...
            AtomicSafetyHandle.CheckReadAndThrow(m_Safety);
#endif
            return m_Data->GetBalancedTreeFactor();
        }
        ...
        /// <summary>
        /// Creates and schedules a job that releases all resources (memory and safety handles) of this aabb tree.
        /// </summary>
        /// <param name="inputDeps">The dependency for the new job.</param>
        /// <returns>The handle of the new job. The job depends upon `inputDeps` and releases all resources (memory and safety handles) of this aabb tree.</returns>
        ...
        public unsafe struct Iterator
        {
            ...
            /// </summary>
            public bool IsLeaf => m_Data->IsLeaf(m_Handle);

...
namespace ProjectDawn.Collections.LowLevel.Unsafe
{
        ...
        where TComparer : unmanaged, IKdTreeComparer<TValue>
    {
        ...
        {
            var branches = new UnsafeLinkedPriorityQueue<Branch, BranchComparer>(Length, Allocator.Temp, new BranchComparer());
        ...
        {
            var branches = new UnsafeLinkedPriorityQueue<Branch, BranchComparer>(Length, Allocator.Temp, new BranchComparer());
            var bestBranches = new UnsafeLinkedPriorityQueue<Branch, BranchComparerDescending>(maxResult, Allocator.Temp, new BranchComparerDescending());
            int count = 0;

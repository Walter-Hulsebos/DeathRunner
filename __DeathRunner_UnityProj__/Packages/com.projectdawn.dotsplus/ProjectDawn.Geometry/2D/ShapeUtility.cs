...
namespace ProjectDawn.Geometry2D
{
    ...
    public static partial class ShapeUtility
    {
        ...
        /// Returns true if shapes surfaces overlap.
        /// </summary>
        public static bool OverlapCapsuleAndPoint(Capsule a, float2 b)
        {
            float2 closestPoint = a.Line.ClosestPoint(b);
            return OverlapCircleAndPoint(new Circle(closestPoint, a.Radius), b);
        }
        ...
        {
            float2 closestPointFrom = b.ClosestPoint(a.Line.From);
            if (OverlapCapsuleAndPoint(a, closestPointFrom))
                return true;
            float2 closestPointTo = b.ClosestPoint(a.Line.To);
        ...
        /// Returns true if shapes surfaces overlap.
        /// </summary>
        public static bool OverlapCapsuleAndCircle(Capsule a, Circle b)
        {
            float2 closestPoint = a.Line.ClosestPoint(b.Center);
            return OverlapCircleAndCircle(new Circle(closestPoint, a.Radius), b);
        }

        /// <summary>
        /// Returns true if shapes surfaces overlap.
        /// </summary>
        public static bool OverlapCapsuleAndRectangle(Capsule a, Rectangle b)
        {
            float2 closestPointFrom = b.ClosestPoint(a.Line.From);
            if (OverlapRectangleAndCircle(b, new Circle(a.Line.ClosestPoint(closestPointFrom), a.Radius)))
                return true;
            float2 closestPointTo = b.ClosestPoint(a.Line.To);
            if (OverlapRectangleAndCircle(b, new Circle(a.Line.ClosestPoint(closestPointTo), a.Radius)))
                return true;
            return false;
        }
        ...
        {
            float2 closestPointFrom = b.Line.ClosestPoint(a.Line.From);
            if (OverlapCapsuleAndCircle(a, new Circle(closestPointFrom, b.Radius)))
                return true;
            float2 closestPointTo = b.Line.ClosestPoint(a.Line.To);
            if (OverlapCapsuleAndCircle(a, new Circle(closestPointTo, b.Radius)))
                return true;
            return false;
        }

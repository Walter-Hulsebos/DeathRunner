...
namespace ProjectDawn.Collections.Tests
{
    internal class NativeLinkedPriorityQueueTests
    {
        ...
        [Test]
        public unsafe void NativeLinkedPriorityQueue_Documentation()
        {
        ...
        [Test]
        public unsafe void NativeLinkedPriorityQueue_IsEmpty()
        {
            var queue = new NativeLinkedPriorityQueue<int, AscendingOrder>(Allocator.Temp, new AscendingOrder());
        ...
        [Test]
        public unsafe void NativeLinkedPriorityQueue_Length()
        {
            var queue = new NativeLinkedPriorityQueue<int, AscendingOrder>(Allocator.Temp, new AscendingOrder());
        ...
        [Test]
        public unsafe void NativeLinkedPriorityQueue_AscendingOrder()
        {
            var queue = new NativeLinkedPriorityQueue<int, AscendingOrder>(Allocator.Temp, new AscendingOrder());
        ...
        [Test]
        public unsafe void NativeLinkedPriorityQueue_DescendingOrder()
        {
            var queue = new NativeLinkedPriorityQueue<int, DescendingOrder>(Allocator.Temp, new DescendingOrder());
        ...
        [Test]
        public unsafe void NativeLinkedPriorityQueue_Peek()
        {
            var queue = new NativeLinkedPriorityQueue<int, AscendingOrder>(Allocator.Temp, new AscendingOrder());
        ...
        [Test]
        public unsafe void NativeLinkedPriorityQueue_Clear()
        {
            var queue = new NativeLinkedPriorityQueue<int, AscendingOrder>(Allocator.Temp, new AscendingOrder());
        ...
        [Test]
        public unsafe void NativeLinkedPriorityQueue_ToArray()
        {
            var queue = new NativeLinkedPriorityQueue<int, AscendingOrder>(Allocator.Temp, new AscendingOrder());
        ...
        [Test]
        public unsafe void NativeLinkedPriorityQueue_Enumerator()
        {
            var queue = new NativeLinkedPriorityQueue<int, AscendingOrder>(Allocator.Temp, new AscendingOrder());
        ...
        [Test]
        public unsafe void NativeLinkedPriorityQueue_Jobified_Read()
        {
            var queue = new NativeLinkedPriorityQueue<int, AscendingOrder>(Allocator.TempJob, new AscendingOrder());
        ...
        [Test]
        public void NativeLinkedPriorityQueue_Dispose()
        {
            var queue = new NativeLinkedPriorityQueue<int, AscendingOrder>(1, Allocator.TempJob);
            queue.Dispose(default).Complete();
        }
    }
}

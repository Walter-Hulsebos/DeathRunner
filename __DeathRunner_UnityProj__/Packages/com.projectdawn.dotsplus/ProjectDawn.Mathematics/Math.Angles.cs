...
namespace ProjectDawn.Mathematics
{
    ...
    public static partial class math2
    {
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool iscollinear(double2 a, double2 b) => abs(determinant(a, b)) < EPSILON_DBL;
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool iscollinear(double3 a, double3 b) => abs(determinant(a, b)) < EPSILON_DBL;
        ...
        /// <returns>Returns angle of direction vector.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static double angle(double2 direction) => atan2(direction.y, direction.x);
        ...
        /// <returns>Returns minimum angle between two direction vectors.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static double angle(double2 a, double2 b) => acos(dot(a, b));
        ...
        /// <returns>Returns minimum angle needed to rotate from direction a to direction b.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static double sangle(double2 a, double2 b) => angle(b) - angle(a);
        ...
        public static double2 rotate(double2 value, double angle)
        {
            double ca = cos(angle);
            double sa = sin(angle);
            return new double2(ca * value.x - sa * value.y, sa * value.x + ca * value.y);
        }

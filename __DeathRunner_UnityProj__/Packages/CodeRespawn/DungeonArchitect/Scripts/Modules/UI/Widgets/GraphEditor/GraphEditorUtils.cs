...
namespace DungeonArchitect.UI.Widgets.GraphEditors
{
    ...
    public class GraphEditorConstants
    {
        ...
        public static readonly Color PIN_COLOR = new(0.4f, 0.4f, 0.4f);
        public static readonly Color PIN_COLOR_HOVER = new(1, 0.6f, 0.0f);
        public static readonly Color PIN_COLOR_CLICK = new(1, 0.9f, 0.0f);

        public static readonly Color NODE_COLOR = new(0.2824f, 0.2824f, 0.2824f); //new Color(0.1f, 0.1f, 0.1f);
        public static readonly Color NODE_COLOR_SELECTED = new(.9f, 0.5f, 0.0f);

        public static readonly Color TEXT_COLOR = new(0.9f, 0.9f, 0.9f);

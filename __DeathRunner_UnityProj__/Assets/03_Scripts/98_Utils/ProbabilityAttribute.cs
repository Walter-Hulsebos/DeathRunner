...
namespace DeathRunner.Utils
{
    ...
    public sealed class ProbabilityAttributeDrawer : OdinAttributeDrawer<ProbabilityAttribute, Single[]>
    {
        ...
        //private InspectorPropertyValueGetter<Object[]> baseItemDataGetter;
        ...
        protected override void Initialize()
        {
            if (this.Attribute.DataMember != null)
            {
                ...
                //InspectorPropertyValueGetter<Object[]> x = new InspectorPropertyValueGetter<Object[]>(this.Property, this.Attribute.DataMember);
                
                this.baseItemDataGetter = ValueResolver.Get<Object[]>(property: this.Property, resolvedString: this.Attribute.DataMember);
            ...
            foreach (ColorPalette __colorPalette in ColorPaletteManager.Instance.ColorPalettes)
            {
                if (__colorPalette.Name == Attribute.ColorName)
                {
                    colors = __colorPalette.Colors.ToArray();
                    break;
                }
            }
        }

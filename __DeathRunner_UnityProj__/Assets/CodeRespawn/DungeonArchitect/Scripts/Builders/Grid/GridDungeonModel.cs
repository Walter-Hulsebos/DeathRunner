...
namespace DungeonArchitect.Builders.Grid
{
    ...
    public class Cell
    {
        ...
        [SerializeField] private Rectangle bounds = new Rectangle();
		...
		[SerializeField] private CellType cellType = CellType.Unknown;
        ...
        /// </summary>
        [SerializeField] private bool userDefined;
        ...
        [SerializeField] private HashSet<int> connectedRooms = new HashSet<int>();
        ...
        [SerializeField] private HashSet<int> fixedRoomConnections = new HashSet<int>();
        ...
        [SerializeField] private HashSet<int> adjacentCells = new HashSet<int>();
    ...
    {
        [SerializeField] private IntVector[] adjacentTiles = new IntVector[2];
        ...
        /// </summary>
        [SerializeField] private int[] adjacentCells = new int[2];
    ...
    {
        [SerializeField] private Dictionary<IntVector2Key, CellDoor> doorLookupCache = new Dictionary<IntVector2Key, CellDoor>();

        [SerializeField] private List<CellDoor> doors = new List<CellDoor>();

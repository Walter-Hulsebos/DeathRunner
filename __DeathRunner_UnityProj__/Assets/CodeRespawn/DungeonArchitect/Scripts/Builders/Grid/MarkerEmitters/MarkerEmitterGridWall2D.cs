...
namespace DungeonArchitect.Builders.Grid
{
    public class MarkerEmitterGridWall2D : DungeonMarkerEmitter
    {
        ...
        private void AddGround2DMarkers(List<Wall2DMarkerInfo> markerList, Dictionary<string, HashSet<IntVector>> occupied, LevelMarkerList gridMarkers, Vector3 gridSize)
        {
        ...
        private void FixCornerWalls(List<Wall2DMarkerInfo> wall2DMarkers, LevelMarkerList gridMarkers, Dictionary<string, HashSet<IntVector>> occupied, Vector3 gridSize) {
        ...
        private void InsertCornerMarker(int cellId, IntVector gridPosition, Vector3 gridSize, List<Wall2DMarkerInfo> wall2DMarkers, Dictionary<string, HashSet<IntVector>> occupied)
        {
        ...
        private Wall2DMarkerInfo GetMarker2D(PropSocket prop, string markerName, Vector3 gridSize)
        {

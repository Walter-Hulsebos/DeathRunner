...
namespace DungeonArchitect.Builders.Snap
{
    ...
    public class SnapBuilder : DungeonBuilder
    {
        ...
        private ModuleBuildNode buildNode;
        ...
        private Bounds GetModulePrefabBounds(GameObject prefab, Bounds bounds)
        {
            if (prefab == null)
            {
                return bounds;
        ...
        private bool FindAttachmentConfiguration(ModuleInfo TargetModule, ModuleInfo IncomingModule, ref Matrix4x4 IncomingModuleTransform,
        ...
        private ModuleBuildNode BuildLayoutRecursive(ModuleGrowthNode GrowthNode, ref HashSet<Bounds> _OccupiedBounds, RNode graphNode, SnapLayoutBuildState RecursiveState) 
        {

...
namespace DungeonArchitect.Builders.CircularCity
{
    ...
    public class CircularCityDungeonBuilder : DungeonBuilder
    {
        ...
        private class SpatialPartitionCache
        {
            ...
            private Dictionary<IntVector2, List<Vector3>> occupancyGrid = new Dictionary<IntVector2, List<Vector3>>();
            ...
            private bool IsFree(Vector3 sourcePosition, IntVector2 cell, float distanceSearch)
            {
                if (!occupancyGrid.ContainsKey(cell))
                {
                    return true;
            ...
            private IntVector2 GetCell(Vector3 position)
            {
        ...
        private void EmitMarkerAt(string markerName, Vector3 worldPosition, Quaternion rotation)
        {

...
namespace DungeonArchitect.Builders.Isaac
{
    public class IsaacDungeonBuilder : DungeonBuilder
    {
        ...
        private List<IsaacRoom> rooms = new List<IsaacRoom>();
        private List<IsaacDoor> doors = new List<IsaacDoor>();
        ...
        private IntVector[] directions = new IntVector[] {
                new IntVector(1, 0, 0),
                new IntVector(0, 0, 1),
                new IntVector(-1, 0, 0),
                new IntVector(0, 0, -1),
        ...
        private void AddNextRoomNode(IsaacRoomFactory roomFactory, 

...
namespace DungeonArchitect.Builders.FloorPlan
{
    ...
    public class FloorPlanBuilder : DungeonBuilder
    {
        ...
        private void SplitChunk(FloorChunk Chunk, float ratio, FloorChunk OutLeft, FloorChunk OutRight, FloorChunk OutHallway)
        {
	        int HallWidth = floorPlanConfig.HallWidth;
	        int Length = Chunk.GetLength();
	        int RemainingLength = Length - HallWidth;
        ...
        private void SplitChunk(FloorChunk Chunk, int LengthLeft, int LengthRight, FloorChunk OutLeft, FloorChunk OutRight, FloorChunk OutHallway)
        {
	        int HallWidth = floorPlanConfig.HallWidth;
        ...
        private void EmitMarkerAt(Vector3 WorldLocation, string MarkerName, Quaternion Rotation)
        {
        ...
        private void EmitMarkerAt(Vector3 WorldLocation, string MarkerName, float Angle)
        {
	        EmitMarkerAt(WorldLocation, MarkerName, Quaternion.Euler(0, Angle, 0));
        }

        private bool VolumeEncompassesPoint(DungeonArchitect.Volume volume, IntVector GridPoint) {
            // TODO: Implement me
            return false;
        }

        private void GetVolumeCells(DungeonArchitect.Volume volume, int y, List<IntVector> OutCells) {
            OutCells.Clear();
            // TODO: Implement me
        }
        ...
        private void ConnectIslandRecursive(int IslandId, Dictionary<int, List<FloorIslandAdjacency>> AdjacencyByIslands, 

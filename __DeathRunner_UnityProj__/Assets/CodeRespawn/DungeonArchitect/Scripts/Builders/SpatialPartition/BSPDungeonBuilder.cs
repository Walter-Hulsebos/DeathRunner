...
namespace DungeonArchitect.Builders.BSP
{
	...
	public class BSPDungeonBuilder : DungeonBuilder {
		...
		private void TraverseTree(BSPNodeObject node, System.Action<BSPNodeObject> visit) {
		...
		private void TraverseParentBranch(BSPNodeObject node, System.Action<BSPNodeObject> visit) {
            if (node == null)
            {
                return;
            }

...
namespace DungeonArchitect.Builders.GridFlow
{
    public class GridFlowDungeonBuilder : DungeonBuilder
    {
        ...
        private bool IsCellOfType(FlowTilemap tilemap, int x, int y, FlowTilemapCellType[] types)
        {
        ...
        private class LayoutGraphLookup
        {
        ...
        private GridFlowLayoutNodeRoomType GetCellRoomType(FlowTilemap tilemap, int x, int y, LayoutGraphLookup layoutGraphLookup)
        {
            var cell = tilemap.Cells.GetCell(x, y);
            if (cell == null)
            {
        ...
        private Quaternion GetBaseRotation(FlowTilemap tilemap, int x, int y)
        {
        ...
        private Matrix4x4 GetBaseTransform()
        {
        ...
        private string GetEdgeMarkerName(FlowTilemapEdgeType edgeType)
        {
        ...
        private bool CreateLockItemMetadata(FlowItem item, ref string doorMarker, out FlowItemMetadata lockItemData)
        {
        ...
        private bool ChunkSupportsWalls(GridFlowLayoutNodeRoomType type)
        {

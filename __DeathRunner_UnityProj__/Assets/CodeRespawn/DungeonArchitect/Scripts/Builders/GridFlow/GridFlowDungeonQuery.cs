...
namespace DungeonArchitect.Builders.GridFlow
{
    public class GridFlowDungeonQuery : DungeonQuery
    {
        ...
        private Dictionary<IntVector2, List<FlowTilemapCell>> tilesByNode = new Dictionary<IntVector2, List<FlowTilemapCell>>();
        private Dictionary<IntVector2, List<FlowTilemapCell>> freeTilesByNode = new Dictionary<IntVector2, List<FlowTilemapCell>>();
        ...
        private void GenerateTileLookup()
        {
        ...
        private List<FlowTilemapCell> FilterWalkablePath(List<FlowTilemapCell> cells)
        {

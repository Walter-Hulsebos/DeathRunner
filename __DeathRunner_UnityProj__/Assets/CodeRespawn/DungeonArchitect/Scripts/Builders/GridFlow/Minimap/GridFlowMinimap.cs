...
namespace DungeonArchitect.Builders.GridFlow
{
    ...
    public class GridFlowMinimap : DungeonMiniMap
    {
        ...
        private FlowTilemapRenderResources resources;
        private GridFlowDungeonModel model;
        private GridFlowDungeonConfig config;
        private int tileSize = 1;
        private List<GridFlowMinimapTrackedObject> trackedObjects = new List<GridFlowMinimapTrackedObject>();
        ...
        private Vector2 WorldToUVCoord(Vector3 position, int tilemapWidth, int tilemapHeight, int textureWidth, int textureHeight)
        {

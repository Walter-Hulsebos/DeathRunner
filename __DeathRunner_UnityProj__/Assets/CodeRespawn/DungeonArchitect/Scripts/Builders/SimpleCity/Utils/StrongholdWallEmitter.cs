...
namespace DungeonArchitect.Builders.SimpleCity
{
    ...
    public class StrongholdWallEmitter : DungeonMarkerEmitter
    {
        ...
        private void EmitWallMarker(DungeonBuilder builder, Vector3 cellSize, float x, float z, float angle)
        {
            EmitMarkerAt(builder, cellSize, WallMarkerName, x, z, angle);
        }

        private void EmitDoorMarker(DungeonBuilder builder, Vector3 cellSize, float x, float z, float angle)
        {
            EmitMarkerAt(builder, cellSize, DoorMarkerName, x, z, angle);
        }

        private void EmitGroundMarker(DungeonBuilder builder, int sizeX, int sizeZ, Vector3 cellSize)
        {
        ...
        private void EmitMarkerAt(DungeonBuilder builder, Vector3 cellSize, string markerName, float x, float z, float angle)
        {

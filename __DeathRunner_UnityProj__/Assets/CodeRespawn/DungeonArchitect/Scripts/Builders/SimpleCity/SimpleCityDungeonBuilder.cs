...
namespace DungeonArchitect.Builders.SimpleCity
{
    ...
    public class SimpleCityDungeonBuilder : DungeonBuilder
    {
        ...
        private void EmitWallMarker(Vector3 cellSize, float x, float z, float angle)
        {
            EmitMarkerAt(cellSize, SimpleCityDungeonMarkerNames.CityWall, x, z, angle);
        }

        private void EmitDoorMarker(Vector3 cellSize, float x, float z, float angle)
        {
            EmitMarkerAt(cellSize, SimpleCityDungeonMarkerNames.CityDoor, x, z, angle);
        }

        private void EmitGroundMarker(int sizeX, int sizeZ, Vector3 cellSize)
        {
        ...
        private void EmitMarkerAt(Vector3 cellSize, string markerName, float x, float z, float angle)
        {

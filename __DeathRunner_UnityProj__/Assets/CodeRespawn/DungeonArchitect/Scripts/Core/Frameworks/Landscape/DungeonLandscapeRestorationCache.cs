...
namespace DungeonArchitect.Landscape
{
    ...
    public class DungeonLandscapeRestorationCache : ScriptableObject
    {
        ...
        [HideInInspector]
        [SerializeField]
        private DLCacheBounds boundsHeight = new DLCacheBounds();
        ...
        [HideInInspector]
        [SerializeField]
        private int numAlphaMaps = 0;

        [HideInInspector]
        [SerializeField]
        private DLCacheBounds boundsAlpha = new DLCacheBounds();
        ...
        [HideInInspector]
        [SerializeField]
        private int numDetailMaps = 0;

        [HideInInspector]
        [SerializeField]
        private DLCacheBounds boundsDetails = new DLCacheBounds();

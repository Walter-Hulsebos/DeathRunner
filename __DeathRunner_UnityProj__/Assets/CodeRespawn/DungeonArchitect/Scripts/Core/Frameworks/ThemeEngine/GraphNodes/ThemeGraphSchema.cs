...
namespace DungeonArchitect.Graphs
{
    public class ThemeGraphSchema : GraphSchema
    {
        ...
        private static bool FindCycles(ref MarkerChildMap markerChildMap, ref List<MarkerNode> cyclePath)
        {
        ...
        private static bool CheckCycleDFS(ref MarkerChildMap markerChildMap, ref List<MarkerNode> traversePath)
        {

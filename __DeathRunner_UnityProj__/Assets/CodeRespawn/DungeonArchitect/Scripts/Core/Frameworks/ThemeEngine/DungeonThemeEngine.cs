...
namespace DungeonArchitect.Themeing
{
    ...
    public class DungeonThemeEngine
    {
        ...
        private DungeonThemeData GetBestMatchedTheme(List<DungeonThemeData> Themes, PropSocket socket, PropBySocketTypeByTheme_t PropBySocketTypeByTheme)
        {
        ...
        private bool ShouldDelayExecution(List<DungeonThemeItem> nodeDataList)
        {
        ...
        private void CreatePropLookup(DungeonThemeData theme, PropBySocketTypeByTheme_t PropBySocketTypeByTheme)
        {

...
namespace DungeonArchitect.RoadNetworks
{
    ...
    public class RoadLayoutBuilder
    {
        ...
        private Dictionary<int, RoadGraphNode> graphNodes = new Dictionary<int, RoadGraphNode>();
        ...
        private void GenerateBoundaryMesh(RoadGraphEdge[] edges, Vector3[] boundaryPoints, List<Vector3> vertices, List<Vector2> uv)
        {
        ...
        private Vector3[] GenerateBlockBoundary(RoadGraphEdge[] edges)
        {
            if (edges.Length == 0)
            {

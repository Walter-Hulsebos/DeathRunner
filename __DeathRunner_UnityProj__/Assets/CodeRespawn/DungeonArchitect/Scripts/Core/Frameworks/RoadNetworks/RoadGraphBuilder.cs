...
namespace DungeonArchitect.RoadNetworks
{
    ...
    public class RoadGraphBuilder
    {
        ...
        private RoadGraphBuildNode FindNearestNode(Vector3 position, float searchRadius)
        {
        ...
        private Dictionary<int, RoadGraphBuildNode> nodes = new Dictionary<int, RoadGraphBuildNode>();

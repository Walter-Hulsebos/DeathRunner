...
namespace DungeonArchitect
{
    ...
    public class DungeonRuntimeNavigation : MonoBehaviour
    {
        ...
        private DungeonNavMeshSourceType meshSourceType = DungeonNavMeshSourceType.MeshData;
        ...
        private List<NavMeshBuildSource> meshSources = new List<NavMeshBuildSource>();

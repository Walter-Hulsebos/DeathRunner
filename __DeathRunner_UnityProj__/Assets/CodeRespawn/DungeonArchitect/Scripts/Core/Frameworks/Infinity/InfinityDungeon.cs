...
namespace DungeonArchitect
{
    ...
    public class InfinityDungeon : MonoBehaviour
    {
        ...
        [SerializeField] private List<InfinityDungeonConfig> spawnedChunks = new List<InfinityDungeonConfig>();
        ...
        private void UpdateChunks(Vector3 buildPosition)
        {
            if (!dungeonBuilt)
            {
                return;
        ...
        private Vector3 ClampOnBuildAxis(Vector3 p)
        {

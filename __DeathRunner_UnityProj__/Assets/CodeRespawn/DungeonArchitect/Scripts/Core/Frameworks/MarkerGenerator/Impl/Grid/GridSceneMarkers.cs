...
namespace DungeonArchitect.MarkerGenerator.Grid
{
    ...
    internal class GridSceneCells<T> where T : new()
    {
    ...
    internal class GridCellOccupancyInfo
    {
    ...
    internal class GridSceneCellsBool : GridSceneCells<GridCellOccupancyInfo>
    {
    ...
    internal class GridSceneMarkerList : GridSceneCells<GridSceneCell>
    {

...
namespace DungeonArchitect.MarkerGenerator.Processor.Grid
{
    public class GridMarkerGenProcessor : IMarkerGenProcessor
    {
        ...
        private struct PatternMatchCoord {
            public int X;
            public int Y;
            public int AsmIdx;
        ...
        private struct ExecutePatternSettings
        {
        ...
        private class GridSceneCellHeights : GridSceneCells<GridCellHeightCoords>
        {
        ...
        private struct GridMarkerGenVmAPISettings
        {
            public Vector2Int Coord;
            public GridMarkerGenRuleType CoordType;

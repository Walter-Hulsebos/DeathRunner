...
namespace DungeonArchitect.Flow.Impl.GridFlow.Tasks
{
    ...
    public class GridFlowLayoutTaskFinalizeGraph : LayoutBaseFlowTaskFinalizeGraph
    {
        ...
        private void AssignRoomTypes(FlowLayoutGraph graph, System.Random random)
        {
        ...
        private GridFlowLayoutNodeRoomType GetNodeRoomType(FlowLayoutGraph graph, FlowLayoutGraphNode node)
        {
        ...
        private GridFlowLayoutNodeRoomType CalculateRoomType(FlowLayoutGraph graph, FlowLayoutGraphLink[] incoming,

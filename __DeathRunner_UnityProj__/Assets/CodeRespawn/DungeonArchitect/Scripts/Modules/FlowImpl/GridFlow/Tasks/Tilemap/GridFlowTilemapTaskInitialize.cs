...
namespace DungeonArchitect.Flow.Impl.GridFlow.Tasks
{
    ...
    public class GridFlowTilemapTaskInitialize : TilemapBaseFlowTaskInitialize
    {
        ...
        private FlowTilemap CropTilemap(FlowTilemap oldTilemap)
        {
        ...
        private void PerturbRoomSizes(FlowLayoutGraphQuery graphQuery, TilemapFlowNodeInfo[,] tileNodes, System.Random random)
        {
        ...
        private void FixCorridorSizes(TilemapFlowNodeInfo[,] tileNodes, FlowLayoutGraphQuery graphQuery)
        {
        ...
        private void RasterizeRoomCorridors(TilemapFlowNodeInfo[,] tileNodes, FlowTilemap tilemap)
        {
            foreach (var tileNode in tileNodes)
            {
        ...
        private bool ShouldBlockCaveBoundary(FlowLayoutGraphQuery graphQuery, FlowLayoutGraphNode caveNode, int dx, int dy)
        {
            /*
        ...
        private void BuildDoors(TilemapFlowNodeInfo[,] tileNodes, FlowTilemap tilemap, FlowLayoutGraphQuery graphQuery)
        {
            bool wallsAsTiles = (wallGenerationMethod == TilemapFlowNodeWallGenerationMethod.WallAsTiles);
        ...
        private IntVector2 GetNodeCoord(FlowLayoutGraphNode node)
        {
        ...
        private bool GetGraphSize(FlowLayoutGraph graph, out IntVector2 size)
        {
            if (graph.Nodes.Count == 0)
            {
        ...
        private FlowTilemapCellType GetCellType(FlowTilemap tilemap, int x, int y)
        {

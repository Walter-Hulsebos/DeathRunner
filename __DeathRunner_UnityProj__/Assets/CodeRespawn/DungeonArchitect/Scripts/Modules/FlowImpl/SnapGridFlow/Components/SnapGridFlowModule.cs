...
namespace DungeonArchitect.Flow.Impl.SnapGridFlow.Components
{
    public class SnapGridFlowModule : MonoBehaviour
    {
        ...
        private class Constants
        {
            ...
            private static readonly float doorSizeX = 0.5f;
            private static readonly float doorSizeY = 1;
        ...
        private void DrawLines(Matrix4x4 transform, Vector3[] points)
        {
        ...
        private void DrawInterChunkBounds(Matrix4x4 transform, Func<int, Vector2, Vector3Int, Vector3> funcCoord, Func<Vector3Int, int> funcSize)
        {
        ...
        private void DrawWireCube(Matrix4x4 transform, Vector3 center, Vector3 extent)
        {

...
namespace DungeonArchitect.Flow.Domains.Layout.Pathing
{
    ...
    internal class FlowLayoutGraphPathUtils {
        ...
        private static FlowLayoutGraphNode CreateMergedCompositeNode(FlowLayoutGraph graph, FlowLayoutGraphQuery graphQuery, FlowLayoutGraphNodeGroup nodeGroup)
        {
    ...
    internal class FlowLayoutPathStackFrame {
    ...
    internal class FFlowLayoutPathingSystemResult
    {
    ...
    internal class FlowPathGrowthSystem : StackSystem<FlowLayoutPathStackFrame, FlowLayoutStaticGrowthState, FlowLayoutSharedGrowthState, FFlowLayoutPathingSystemResult>
    {
    ...
    */
    internal class FFlowAgPathingSystem
    {

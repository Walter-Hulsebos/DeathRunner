...
namespace DungeonArchitect.Flow.Domains.Tilemap
{
    ...
    public class FlowTilemapRenderer
    {
        ...
        private static Color GetEdgeColor(FlowTilemapEdgeType edgeType)
        {
        ...
        private static TilemapLayerRenderData[] BuildQuadData(FlowTilemap tilemap, int tileSize, FlowTilemapRenderResources resources, System.Func<FlowTilemapCell, bool> FuncCellSelected)
        {
        ...
        private static void DrawTileEdge(float x0, float y0, float x1, float y1, FlowTilemapEdge edge, FlowTilemapRenderResources resources, Color color, Material material, Dictionary<Material, List<TilemapRenderQuad>> quadsByMaterial)
        {
            var v0 = new TilemapRenderVert(new Vector2(x0, y0), new Vector2(0, 1));
            var v1 = new TilemapRenderVert(new Vector2(x0, y1), new Vector2(0, 0));
            var v2 = new TilemapRenderVert(new Vector2(x1, y1), new Vector2(1, 0));
        ...
        private static Color GetCellColor(FlowTilemapCell cell)
        {

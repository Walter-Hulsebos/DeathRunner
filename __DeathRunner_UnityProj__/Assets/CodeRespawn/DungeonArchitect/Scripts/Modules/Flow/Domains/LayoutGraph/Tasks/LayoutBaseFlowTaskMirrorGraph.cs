...
namespace DungeonArchitect.Flow.Domains.Layout.Tasks
{
    public abstract class LayoutBaseFlowTaskMirrorGraph : FlowExecTask
    {
        ...
        private void FixNodeCoords(FlowLayoutGraph graph)
        {
            Vector3 graphCoordMin, graphCoordMax;
            GetGraphBounds(graph, out graphCoordMin, out graphCoordMax);
        ...
        private void MirrorGraph(FlowLayoutGraph graph, System.Func<Vector3, Vector3> funcGetMirrorCoord, System.Func<Vector3, bool> funcShouldMirror,
        ...
        private bool GetGraphBounds(FlowLayoutGraph graph, out Vector3 graphCoordMin, out Vector3 graphCoordMax)
        {

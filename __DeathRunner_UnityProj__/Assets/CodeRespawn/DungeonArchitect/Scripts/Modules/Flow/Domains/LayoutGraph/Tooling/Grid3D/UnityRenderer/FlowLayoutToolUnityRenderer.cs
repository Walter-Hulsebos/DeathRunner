...
namespace DungeonArchitect.Flow.Domains.Layout.Tooling.Graph3D
{
    ...
    [System.Serializable]
    internal class FlowLayoutGraphUnityVisualizerObject
    {
        [SerializeField]
    ...
    public class FlowLayoutGraphUnityVisualizer
    {
        ...
        private void BuildRecursive(SxRenderContext context, ISxSceneNode node, Transform parent, Matrix4x4 incomingWorldTransform, HashSet<ISxSceneNode> visited, int depth, Dictionary<ISxSceneNode, Transform> nodeTransforms)
        {

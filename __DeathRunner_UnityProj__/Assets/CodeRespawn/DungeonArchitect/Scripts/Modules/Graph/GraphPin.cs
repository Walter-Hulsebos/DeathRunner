...
namespace DungeonArchitect.Graphs
{
    ...
    {
        private GraphPinMouseState clickState = GraphPinMouseState.None;
        /// <summary>
        ...
        [SerializeField] private GraphPinType pinType;
        ...
        /// </summary>
        [SerializeField] private GraphNode node;
        ...
        [SerializeField] private Rect boundsOffset = new Rect(0, 0, 20, 20);
        /// <summary>
        ...
        [SerializeField] private Vector2 tangent = new Vector2();
        /// <summary>
        ...
        [SerializeField] private float tangentStrength = 50;
        /// <summary>
        ...
        private bool requestLinkDeletionInitiated = false;

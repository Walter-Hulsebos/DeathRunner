...
namespace DungeonArchitect.UI.Widgets
{
    ...
    {
        private List<GridPanelNode> nodes = new List<GridPanelNode>();
        private GridPanelArrangementType arrangement = GridPanelArrangementType.VerticalScroll;
        private IntVector2 padding = new IntVector2(10, 10);
        public Vector2 cellSize = new Vector2(100, 100);
        public Vector2 desiredCellSize = Vector2.zero;
        public bool autoSize = false;


        private IntVector2 renderedCells = new IntVector2(0, 0);

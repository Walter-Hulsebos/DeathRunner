...
namespace DungeonArchitect.UI.Widgets.GraphEditors
{
    ...
    {
        private GraphNodeRenderer defaultRenderer = new GraphNodeRenderer();
        private Dictionary<Type, GraphNodeRenderer> renderers = new Dictionary<Type, GraphNodeRenderer>();

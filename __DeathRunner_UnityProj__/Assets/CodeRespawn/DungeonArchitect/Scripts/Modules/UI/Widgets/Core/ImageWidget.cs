...
namespace DungeonArchitect.UI.Widgets
{
    ...
    public class ImageWidget : WidgetBase
    {
        ...
        private ImageWidgetDrawMode drawMode = ImageWidgetDrawMode.Streach;
        ...
        private Vector2 CalculateFitSize(Vector2 size)
        {
        ...
        private Vector2 CalculateFillSize(Vector2 size)
        {
            if (texture == null) return size;

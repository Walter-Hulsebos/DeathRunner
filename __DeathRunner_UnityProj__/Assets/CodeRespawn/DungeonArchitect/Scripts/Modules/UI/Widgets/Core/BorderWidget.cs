...
namespace DungeonArchitect.UI.Widgets
{
    public class BorderWidget : WidgetBase
    {
        ...
        private Color titleColor = new Color(0.75f, 0.75f, 0.75f);
        private Vector2 titleOffset = new Vector2(5, 4);
        private bool drawOutline = true;

        private IWidget titleWidget;
        private System.Func<string> TitleGetter;

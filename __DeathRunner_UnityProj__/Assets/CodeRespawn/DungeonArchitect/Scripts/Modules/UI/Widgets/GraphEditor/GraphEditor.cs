...
namespace DungeonArchitect.UI.Widgets.GraphEditors
{
    ...
    public abstract class GraphEditor : ScriptableObject, IWidget
    {
        ...
        */
        ...
        private void DrawGrid(UIRenderer renderer, Rect bounds, Vector2 worldSize)
        {
        ...
        private void HandleMouseDraggedLinkReleased(Vector2 mousePositionScreen, UISystem uiSystem)
        {
        ...
        private void ClearBackground(UIRenderer renderer, Rect bounds, Color color)
        {
            var guiState = new GUIState(renderer);
    ...
    public class GraphSelectionBox
    {
        ...
        private void UpdateBounds(Vector2 start, Vector2 end)
        {
    ...
    {
        private Dictionary<KeyCode, bool> state = new Dictionary<KeyCode, bool>();
        private bool shift;
    ...
    internal class CursorDragLink
    {
        ...
        private Vector2 mouseScreenPosition = new Vector2();

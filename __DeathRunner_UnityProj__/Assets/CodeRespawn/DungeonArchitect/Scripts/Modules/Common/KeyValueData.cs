...
namespace DungeonArchitect.Utils
{
    ...
    {
        [SerializeField] private List<KeyValueDataEntryFloat> dataFloat = new List<KeyValueDataEntryFloat>();
        [SerializeField] private List<KeyValueDataEntryInt> dataInt = new List<KeyValueDataEntryInt>();
        [SerializeField] private List<KeyValueDataEntryString> dataString = new List<KeyValueDataEntryString>();
        [SerializeField] private List<KeyValueDataEntryVector3> dataVector3 = new List<KeyValueDataEntryVector3>();
        [SerializeField] private List<KeyValueDataEntryVector2> dataVector2 = new List<KeyValueDataEntryVector2>();

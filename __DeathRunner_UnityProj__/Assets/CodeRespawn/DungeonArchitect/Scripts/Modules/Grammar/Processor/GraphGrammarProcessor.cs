...
namespace DungeonArchitect.Grammar
{
    ...
    public class GraphGrammarProcessor 
    {
        ...
        private void RunGraphGenerationScripts(SnapFlowAsset asset)
        {
        ...
        private void ApplyRule(RGraph dataGraph, RuntimeGrammarProduction rule)
        {
        ...
        private Dictionary<int, RNode> CreateNodeByIndexMap(RGraph graph)
        {
        ...
        private void ApplyMatch(RGraph dataGraph, RGraph lhs, RGraph rhs, Dictionary<RNode, RNode> LHSToDataNode)
        {
            // Break the links
            {
    ...
    internal class GraphPatternMatcher
    {
        ...
        private static bool IsNodeDataEqual(RNode a, RNode b)
        {
        ...
        private static bool TraverseChildren(List<RNode> dataChildNodes, List<RNode> patternChildNodes,

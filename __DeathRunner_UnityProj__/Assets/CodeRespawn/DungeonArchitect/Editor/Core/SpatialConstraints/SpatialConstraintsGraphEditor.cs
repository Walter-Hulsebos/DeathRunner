...
{
    internal enum SpatialConstraintEditorMenuAction
    {
        CreateRuleNode,
        CreateCommentNode,
        MakeOwnerNode
    ...
    public class SpatialConstraintsGraphEditor : GraphEditor
    {
        ...
        private void HandleAction(SpatialConstraintEditorMenuAction action, GraphContextMenuEvent e)
        {
        ...
        private void CreateCommentNode(Vector2 screenPos, UISystem uiSystem)
        {
        ...
        private void CreateSpatialNodeAtMouse<T>(Vector2 screenPos, UISystem uiSystem) where T : SCBaseDomainNode
        {
            var worldPos = camera.ScreenToWorld(screenPos);
        ...
        private void DrawNodeDragOverlay(UIRenderer renderer, Rect bounds)
        {
        ...
        private void SnapNodes(GraphNode[] nodes)
        {

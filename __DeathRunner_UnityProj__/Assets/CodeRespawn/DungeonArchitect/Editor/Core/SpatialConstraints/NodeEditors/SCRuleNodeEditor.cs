...
namespace DungeonArchitect.Editors.SpatialConstraints
{
    ...
    {
        private RuleNodeEditorUIState uiState;
        private SerializedProperty constraintEvaluationMode;
        private SerializedProperty exclusionRuleSearchRadius;
        private SerializedProperty exclusionRuleMarkersToRemove;
        ...
        private void ShowTabRemovalRules()
        {
        ...
        private void ShowTabConstraintRules()
        {
        ...
        private void EmitEvaluationModeWidget(SCRuleNode node)
        {
        ...
        private void AddConstraintRule(System.Type constraintType)
        {
        ...
        private void DestroyConstraintRule(ConstraintRule rule)
        {
            var ruleNode = target as SCRuleNode;
        ...
        private void EmitConstraintScript(ConstraintRule constraint, RuleNodeEditorUIState.ConstraintUIState constraintUI)
        {
        ...
        private void HandleAddConstratinMenuClick(object constraintTypeObject)
        {
        ...
        private void EmitAddConstraintWidget()
        {
        ...
        private class RuleNodeEditorUIState
        {

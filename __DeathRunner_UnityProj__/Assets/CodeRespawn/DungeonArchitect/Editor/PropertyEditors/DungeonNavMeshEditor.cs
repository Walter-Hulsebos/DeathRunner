...
namespace DungeonArchitect.Editors
{
	...
	public class DungeonNavMeshEditor : Editor
	{
		...
		private SerializedProperty agentClimbHeight;
		private SerializedProperty cellSize;
		private SerializedProperty maxCrowdAgents;
		private SerializedProperty visualize2D;
		...
		private Vector3 ToV3(SharpNav.PolyVertex v)
		{
		...
		private void FlipFor2D(ref Vector3 v)
		{
			var t = v.y;
			v.y = v.z;
			v.z = t;

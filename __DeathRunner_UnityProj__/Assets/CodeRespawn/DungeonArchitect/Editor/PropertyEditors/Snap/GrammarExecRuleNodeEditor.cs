...
namespace DungeonArchitect.Editors.SnapFlow
{
    ...
    public class GrammarExecRuleNodeEditor : Editor
    {
        ...
        private SerializedProperty runProbability;
        private SerializedProperty iterateCount;
        private SerializedProperty minIterateCount;
        private SerializedProperty maxIterateCount;

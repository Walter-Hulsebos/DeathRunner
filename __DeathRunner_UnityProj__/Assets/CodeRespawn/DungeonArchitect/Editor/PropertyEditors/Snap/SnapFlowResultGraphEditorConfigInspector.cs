...
namespace DungeonArchitect.Editors.SnapFlow
{
    ...
    public class SnapFlowResultGraphEditorConfigInspector : Editor
    {
        ...
        private SerializedProperty configLayered_Separation;

        private SerializedProperty configSpring_springDistance;
        private SerializedProperty configSpring_nodeDistance;

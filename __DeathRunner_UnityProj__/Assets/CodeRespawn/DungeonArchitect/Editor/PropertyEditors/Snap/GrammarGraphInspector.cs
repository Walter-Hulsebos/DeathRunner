...
namespace DungeonArchitect.Editors.SnapFlow
{
    ...
    public class GrammarGraphInspector : Editor
    {
        ...
        private SerializedProperty useProceduralScript;
        ...
        private ScriptableObject generatorInstanceCache = null;
        private MonoScript generatorMonoScriptCache = null;

        private void UpdateGeneratorInstance(string scriptClassName)
        {
        ...
        private void PerformLayout(GrammarGraph graph)
        {
        ...
        private void ExecuteGeneratorScript(IGrammarGraphBuildScript generatorScript, GrammarGraph grammar, SnapFlowAsset flowAsset, UIPlatform platform, UIUndoSystem undo)
        {
        ...
        private void FocusEditorOnGrammar(SnapEditorWindow editorWindow, GrammarGraph grammar, GrammarProductionRule productionRule)
        {
        ...
        private GrammarProductionRule GetProductionRule(SnapFlowAsset flowAsset, GrammarGraph grammar)
        {

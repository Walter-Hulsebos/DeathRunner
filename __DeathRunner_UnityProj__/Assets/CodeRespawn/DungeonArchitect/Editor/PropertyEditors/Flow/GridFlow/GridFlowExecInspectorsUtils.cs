...
{
    internal class GridFlowExecNodePlacementSettingInspector
    {
        private DAInspectorMonoScriptProperty<ITilemapItemPlacementStrategy> scriptProperty;
        private string settingsVariableName;
        private string title;
        private TilemapItemPlacementSettings settings;

...
namespace DungeonArchitect.UI.Widgets.GraphEditors
{
    ...
    public class CommentNodeEditor : Editor
    {
        ...
        private const int CATEGORY_SPACING = 10;
    ...
    public class CommentNodeRenderer : GraphNodeRenderer
    {
        ...
        private void DrawMessage(UIRenderer renderer, GraphRendererContext rendererContext, CommentNode node, GraphCamera camera)
        {

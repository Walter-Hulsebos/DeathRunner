...
namespace DungeonArchitect.Editors
{
	...
	public class GridDungeonConfigEditor : Editor {
	    ...
	    private SerializedProperty NumCells;
	    private SerializedProperty MinCellSize;
	    private SerializedProperty MaxCellSize;

	    private SerializedProperty RoomAreaThreshold;
		//SerializedProperty FloorHeight;
		private SerializedProperty RoomAspectDelta;
		private SerializedProperty CorridorWidth;
		private SerializedProperty InitialRoomRadius;
		private SerializedProperty SpanningTreeLoopProbability;
		private SerializedProperty StairConnectionTollerance;
		private SerializedProperty HeightVariationProbability;
		private SerializedProperty NormalMean;
		private SerializedProperty NormalStd;
		private SerializedProperty GridCellSize;
		private SerializedProperty MaxAllowedStairHeight;
		private SerializedProperty Mode2D;
		private SerializedProperty DoorProximitySteps;

		private SerializedProperty UseFastCellDistribution;
		private SerializedProperty CellDistributionWidth;
		private SerializedProperty CellDistributionLength;
		private SerializedProperty WallLayoutType;

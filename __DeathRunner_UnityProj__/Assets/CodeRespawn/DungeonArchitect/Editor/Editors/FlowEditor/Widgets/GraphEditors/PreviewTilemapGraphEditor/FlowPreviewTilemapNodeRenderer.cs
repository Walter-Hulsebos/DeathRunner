...
namespace DungeonArchitect.Editors.Flow.Tilemap
{
    ...
    {
        private string tilemapNodeId;
        private RenderTexture tilemapTexture;
        public event OnFlowLayoutGraphItemRendered FlowAbstractGraphItemRendered;


        private IntVector2 GetNodeCoord(Vector3 coordF)
        {
        ...
        private void DrawItems(UIRenderer renderer, GraphRendererContext rendererContext, FlowTilemapToolGraphNode node, GraphCamera camera)
        {

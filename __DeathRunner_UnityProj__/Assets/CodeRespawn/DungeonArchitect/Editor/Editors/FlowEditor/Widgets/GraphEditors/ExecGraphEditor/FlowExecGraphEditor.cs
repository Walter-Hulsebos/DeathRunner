...
namespace DungeonArchitect.Editors.Flow
{
    public class FlowExecGraphEditor : GraphEditor
    {
        ...
        private void CreateExecRuleNode(Vector2 screenPos, System.Type nodeHandlerType, UISystem uiSystem)
        {
    ...
    internal class FlowExecGraphContextMenuUserData
    {
    ...
    internal class FlowExecGraphContextMenu : GraphContextMenu
    {
        ...
        private System.Type[] GetNodeHandlerTypes()
        {

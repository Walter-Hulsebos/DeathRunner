...
namespace DungeonArchitect.Editors.Flow.DomainEditors.Tilemap
{
    ...
    {
        private FlowTilemap tilemap = null;
        
        [SerializeField] private FlowTilemapToolGraph tilemapTool;
        
        [SerializeField] private GraphPanel<FlowPreviewTilemapGraphEditor> tilemapPanel;

        private Layout2DGraphDomainEditor layoutDomainEditor;
        private IntVector2 lastTilemapCellClicked = IntVector2.Zero;
        private bool tilemapDirty = false;
        ...
        private FlowTilemapToolBuildContext BuildContext { get; } = new FlowTilemapToolBuildContext();

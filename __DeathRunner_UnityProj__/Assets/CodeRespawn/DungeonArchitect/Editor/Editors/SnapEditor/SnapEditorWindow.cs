...
namespace DungeonArchitect.Editors.SnapFlow
{
    ...
    {
        private ProductionRuleWidget ruleEditor;
        private RuleListPanel ruleListPanel;
        private NodeListPanel nodeListPanel;
        private ErrorListPanel errorListPanel;

        private GraphPanel<SnapEdResultGraphEditor> resultGraphPanel;
        private GraphPanel<SnapEdExecutionGraphEditor> execGraphPanel;
        private SpacerWidget toolbarPadding;

        private DungeonFlowErrorList errorList;
        ...
        private readonly static string CMD_EXEC_GRAMMAR = "ExecuteGrammar";
        ...
        private void UpdateProductionRuleGraphCameras(GrammarProductionRule rule)
        {
            if (ruleEditor != null)
            {
        ...
        private void UpdateDragDropState(Event e)
        {
            if (uiSystem != null)
            {
    ...
    internal class DungeonFlowEditorHighlighter
    {
    ...
    internal class EditorCommand_ExecuteSnapFlowGraph : DeferredUICommandBase
    {

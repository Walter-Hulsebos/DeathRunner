...
namespace DungeonArchitect.Editors.SnapFlow
{
    public class SnapEditorUtils 
    {
        ...
        private static T CreateGraphNode<T>(Vector2 position, Graph graph, SnapFlowAsset asset, UIPlatform platform) where T : GraphNode
        {
        ...
        private static void InitializeStartRule(GrammarProductionRule startRule, GrammarNodeType startNodeType, GrammarNodeType taskNodeType, SnapFlowAsset asset, UIPlatform platform)
        {

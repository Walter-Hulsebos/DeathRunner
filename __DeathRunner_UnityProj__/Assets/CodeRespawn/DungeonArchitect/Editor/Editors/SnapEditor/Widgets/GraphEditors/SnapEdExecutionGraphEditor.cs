...
namespace DungeonArchitect.Editors.SnapFlow
{
    ...
    internal class SnapEdExecutionGraphEditorMenuData
    {
    ...
    public class SnapEdExecutionGraphEditor : GraphEditor
    {
        ...
        private GrammarProductionRule GetDragData()
        {
        ...
        private bool IsDragDataSupported()
        {
        ...
        private GrammarExecRuleNode CreateNewExecRuleNode(GrammarProductionRule rule, Vector2 mousePosition, UISystem uiSystem)
        {

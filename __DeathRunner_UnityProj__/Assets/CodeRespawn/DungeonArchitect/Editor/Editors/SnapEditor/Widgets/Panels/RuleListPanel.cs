...
{
    internal class RuleListViewConstants
    {
    ...
    {
        private HighlightWidget highlight;
    ...
    public class RuleListPanel : WidgetBase
    {
        ...
        private readonly static string BTN_ADD_ITEM = "AddItem";
        private readonly static string BTN_REMOVE_ITEM = "RemoveItem";
        private readonly static string BTN_MOVE_UP = "MoveUp";
        private readonly static string BTN_MOVE_DOWN = "MoveDown";

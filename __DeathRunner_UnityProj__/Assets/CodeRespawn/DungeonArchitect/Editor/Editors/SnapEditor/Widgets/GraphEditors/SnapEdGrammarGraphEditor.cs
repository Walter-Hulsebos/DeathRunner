...
namespace DungeonArchitect.Editors.SnapFlow
{
    ...
    public class SnapEdGrammarGraphEditor : GraphEditor
    {
        ...
        private T GetDragData<T>() where T : Object
        {
        ...
        private GrammarTaskNode CreateNewTaskNode(GrammarNodeType nodeType, Vector2 mousePosition, bool selectAfterCreate, UISystem uiSystem)
        {

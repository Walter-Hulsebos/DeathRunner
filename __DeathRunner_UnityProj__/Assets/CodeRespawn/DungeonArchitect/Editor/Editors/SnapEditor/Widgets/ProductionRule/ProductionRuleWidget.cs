...
namespace DungeonArchitect.Editors.SnapFlow
{
    ...
    {
        private SnapFlowAsset flowAsset;
        private GrammarProductionRule productionRule;
        private GraphPanel<SnapEdGrammarGraphEditor> LHSGraphPanel;
        private List<ProductionRuleWidgetRHSState> RHSEditorStates = new List<ProductionRuleWidgetRHSState>();
        ...
        private GrammarGraph GetWidgetGraph(IWidget widget)
        {
        ...
        private void SetGraphPanelEditorSize(IWidget widget, float size)
        {
        ...
        private bool GetGraphPanelEditorSize(IWidget widget, ref float size)
        {
            var graph = GetWidgetGraph(widget);
            if (graph != null && graph.editorData != null)
            {
        ...
        private ProductionRuleWidgetRHSState AddNewRHSState(UISystem uiSystem)
        {
        ...
        private ProductionRuleWidgetRHSState AddRHSState(WeightedGrammarGraph RHSGraph, UISystem uiSystem)
        {
            if (RHSGraph == null)
            {
                return null;
        ...
        private void RemoveRHSState(ProductionRuleWidgetRHSState state)
        {

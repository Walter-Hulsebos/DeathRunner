...
namespace DungeonArchitect.Editors.ThemeEditorTools
{
    ...
    internal interface IBulkPrefabReplaceRuleProcessor
    {
        void DrawGUI();
        BulkReplacementEntry[] Process(DungeonThemeEditorWindow editor);
    }

    internal class BulkReplacementEntry
    {
    ...
    internal class DirectoryBulkPrefabReplaceRuleProcessor : IBulkPrefabReplaceRuleProcessor
    {
        ...
        /// </summary>
        /// <returns></returns>
        private Dictionary<string, FileInfo> GetTargetFiles()
        {
    ...
    internal class BulkPrefabReplaceRuleFactory
    {
    ...
    internal class BulkPrefabReplacementWindow : EditorWindow
    {
        private BulkPrefabReplacementRuleType ruleType = BulkPrefabReplacementRuleType.Directory;
        private IBulkPrefabReplaceRuleProcessor ruleProcessor = null;
        private DungeonThemeEditorWindow graphEditor = null;
        ...
        private bool PerformReplacements(BulkReplacementEntry[] replacements)
        {
        ...
        private static string ChopPreAssetPath(string path)
        {
            int index = path.IndexOf("Assets");
            return (index != -1) ? path.Substring(index) : path;
        }

        private string GetReplacementReport(BulkReplacementEntry[] replacements)
        {
        ...
        private static string GetRuleDescription(BulkPrefabReplacementRuleType ruleType)
        {
            switch (ruleType)
            {
                case BulkPrefabReplacementRuleType.Directory:
        ...
        private static readonly int INDENT_SPACING = 10;

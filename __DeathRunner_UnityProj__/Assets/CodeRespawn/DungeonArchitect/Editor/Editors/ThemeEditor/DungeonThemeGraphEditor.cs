...
namespace DungeonArchitect.Editors
{
    public class DungeonThemeGraphEditor : GraphEditor
    {
        ...
        private readonly DungeonObjectTracker dungeonObjectTracker = new DungeonObjectTracker();
        ...
        [SerializeField] private ThemeEditorSceneVisualizer visualizer = new ThemeEditorSceneVisualizer();
        ...
        private void CreateSpatialConstraintAsset(VisualNode visualNode, UISystem uiSystem)
        {
            if (visualNode.spatialConstraint == null)
            {
        ...
        private void UpdateSpatialConstraintEditorWindow(UISystem uiSystem)
        {
        ...
        private void UpdateSpatialConstraintEditorWindow(GraphNode[] nodes)
        {
        ...
        private class SpatialConstraintWindowState
        {
        ...
        private SpatialConstraintWindowState spatailWindowState = new SpatialConstraintWindowState();

        private void SetSpatialConstraintEditorAsset(SpatialConstraintAsset spatialAsset, SpatialConstraintsEditorAssignmentState state)
        {
        ...
        private MarkerEmitterNode CreateMarkerEmitterNode(Vector2 mouseScreenPos, string markerName, UISystem uiSystem)
        {
    ...
    /// </summary>
    internal class DungeonObjectTracker
    {
        ...
        private Dungeon[] _dungeons = new Dungeon[0];
        ...
        /// </summary>
        private void FindDungeonObjects()
        {
    ...
    /// </summary>
    internal class NodeDeletionOrderComparer : IComparer<GraphNode>
    {
        private int GetWeight(GraphNode node)
        {
    ...
    /// </summary>
    internal class GraphPinHierarchyComparer : IComparer<GraphPin>
    {
        private int GetWeight(GraphNode node)
        {

...
namespace DungeonArchitect.Editors
{
    ...
    public abstract class VisualNodeEditor : PlaceableNodeEditor
	{
		...
		private SerializedProperty affectsNavigation;
		private SerializedProperty useSpatialConstraint;
		private InstanceCache instanceCache = new InstanceCache();
		private bool foldoutSpatialAdvanced = false;
        ...
        private void DrawSpatialConstraintCategory()
        {
        ...
        private void DrawRule<T>(string caption, ref bool ruleEnabled, ref string ruleClassName) where T : ScriptableObject
        {
            GUI.enabled = true;

...
namespace DungeonArchitect.Editors
{
    ...
    {
        [SerializeField] private DungeonThemeGraphEditor graphEditor;
        ...
        private ThemeEditorToolFunctionInfo[] toolFunctions;

        private static ThemeEditorToolFunctionInfo[] FetchToolFunctions()
        {
        ...
        private void HandleVisualizeMarkerButtonPressed()
        {
        ...
        private void ToolFunctionInvoker(object userData)
        {
            var toolFunction = userData as ThemeEditorToolFunctionDelegate;
            toolFunction(this);
        }

        private void Advanced_OnCreateNodeIds() {
        ...
        private void OnRefreshThumbnail() {
			AssetThumbnailCache.Instance.Reset();
		}

        private void OnJumpTo_MarkerName(object userdata)
        {
        ...
        private void OnJumpTo_CenterGraph()
        {
            if (graphEditor != null)
            {

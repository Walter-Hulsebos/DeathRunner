...
namespace DungeonArchitect.Editors.MarkerGenerator.Editors.Grid.Actors
{
    ...
    {
        private readonly Dictionary<Vector2Int, SxGridMarkerGenGroundItemComponent> tiles = new Dictionary<Vector2Int, SxGridMarkerGenGroundItemComponent>();
        private readonly Dictionary<Vector2Int, SxGridMarkerGenGroundItemComponent> edgesX = new Dictionary<Vector2Int, SxGridMarkerGenGroundItemComponent>();
        private readonly Dictionary<Vector2Int, SxGridMarkerGenGroundItemComponent> edgesZ = new Dictionary<Vector2Int, SxGridMarkerGenGroundItemComponent>();
        private readonly Dictionary<Vector2Int, SxGridMarkerGenGroundItemComponent> corners = new Dictionary<Vector2Int, SxGridMarkerGenGroundItemComponent>();
        ...
        private SxGridMarkerGenGroundItemComponent CreateItem(Vector3 location, Vector2 scale)
        {

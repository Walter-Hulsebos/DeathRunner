...
namespace DungeonArchitect.Editors.MarkerGenerator.Editors.Grid
{
    public class GridMarkerGenEditor : MarkerGenEditor
    {
        ...
        private void DeleteRule(SxGridPatternRuleActor ruleActor, UIPlatform platform)
        {
            if (ruleActor != null)
            {
        ...
        private GridMarkerGenRule GetRuleAt(Vector2Int coord, GridMarkerGenRuleType ruleType)
        {
        ...
        private SxGridPatternRuleActor AddNewRule(Vector2Int coord, GridMarkerGenRuleType ruleType, UIPlatform platform)
        {
        ...
        private SxGridPatternRuleActor CreateRuleActor(SxWorld world, GridMarkerGenRule rule)
        {

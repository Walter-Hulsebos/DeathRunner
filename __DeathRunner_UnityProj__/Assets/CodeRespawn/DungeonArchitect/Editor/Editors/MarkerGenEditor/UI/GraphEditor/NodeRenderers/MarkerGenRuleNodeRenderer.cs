...
namespace DungeonArchitect.Editors.MarkerGenerator.UI.NodeRenderers
{
    public class MarkerGenRuleNodeRenderer : GraphNodeRenderer
    {
        ...
        private bool IsStateInvalid()
        {
            return styleBody == null || styleTitle == null;
        }

        private void InitializeState(UIRenderer renderer)
        {
        ...
        private bool IsPinConnected(GraphPin pin)
        {
        ...
        private Texture2D GetPinTexture(MarkerGenRuleGraphPin pin)
        {
        ...
        private Vector2 CalcSize(MarkerGenRuleGraphPin pin, GUIStyle style)
        {

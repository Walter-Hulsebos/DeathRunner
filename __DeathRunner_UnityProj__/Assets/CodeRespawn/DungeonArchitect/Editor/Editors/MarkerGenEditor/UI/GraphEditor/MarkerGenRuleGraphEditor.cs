...
namespace DungeonArchitect.Editors.MarkerGenerator.UI
{
    ...
    internal class MarkerGenRuleGraphContextMenuUserData
    {
    ...
    internal class MarkerGenRuleGraphContextMenu : GraphContextMenu
    {
        ...
        private void AddMenuItem<T>(string name, string subMenu, IContextMenu menu, UISystem uiSystem)
        {
        ...
        private void PopulateConditionItems(IContextMenu menu, UISystem uiSystem, string subMenu = "")
        {
        ...
        private void PopulateActionItems(IContextMenu menu, UISystem uiSystem, string subMenu = "")
        {
        ...
        private void PopulateDebugItems(IContextMenu menu, UISystem uiSystem)
        {
        ...
        private void HandleContextMenu(object action)
        {

...
namespace DungeonArchitect.Editors.MarkerGenerator
{
    public class MarkerGenEditorWindow : EditorWindow
    {
        ...
        private static readonly string BTN_RECENTER_VIEW = "RecenterView";
        ...
        private void FindAndRebuildTrackedDungeons()
        {
        ...
        private void InitializeRuleGraphCamera()
        {
        ...
        private bool IsEditorStateInvalid()
        {

...
namespace DungeonArchitect.Samples.ShooterGame {
	public class SpecialRoomFinder : DungeonEventListener {
        ...
        private void SetStartingCell(GridDungeonModel model, Cell cell) {
        ...
        private void SetEndingCell(GridDungeonModel model, Cell cell) {
            var roomCenter = MathUtils.GridToWorld(model.Config.GridCellSize, cell.CenterF);
        ...
        private void CreateLevelGoalAt(Vector3 position) {

...
public class FloorPlanRoomMarkers : DungeonMarkerEmitter {
    ...
    private void DecorateRoom(DungeonBuilder builder, FloorChunk roomChunk, Vector3 gridSize)
    {
    ...
    private void EmitChunkMarker(DungeonBuilder builder, string markerName, Vector3 gridPositionF, float angle, Vector3 gridSize, int cellId)
    {

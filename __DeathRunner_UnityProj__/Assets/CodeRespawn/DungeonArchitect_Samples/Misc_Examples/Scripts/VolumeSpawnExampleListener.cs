...
public class VolumeSpawnExampleListener : DungeonEventListener {
    ...
    [SerializeField] private List<GameObject> managedVolumes = new List<GameObject>();
    ...
    private void DecorateRoom(Dungeon dungeon, GridDungeonModel gridModel, Cell cell, Graph theme)
    {
    ...
    private void FindStartEndRooms(GridDungeonModel gridModel, out Cell spawnCell, out Cell finalBossCell)
    {

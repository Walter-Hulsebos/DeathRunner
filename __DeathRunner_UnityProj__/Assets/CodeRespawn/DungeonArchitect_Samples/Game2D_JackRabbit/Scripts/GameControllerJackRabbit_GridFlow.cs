...
namespace JackRabbit {
	public class GameControllerJackRabbit_GridFlow : MonoBehaviour, IJackRabbitGameController
    {
		...
		private DungeonArchitect.Samples.ShooterGame.LevelNpcSpawner npcSpawner;
		private DungeonArchitect.Samples.ShooterGame.WaypointGenerator waypointGenerator;

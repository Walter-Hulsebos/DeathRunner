...
{
    [System.Serializable]
    internal class ScreenPageNewsJsonData : ScreenPageJsonDataBase
    {
    ...
    {
        private IWidget BuildFeaturedWidget(ScreenPageNewsJsonData jsonData)
        {
        ...
        private LaunchPadCardWidget BuildCardWidget(DataCardEntry entry, float height)
        {
        ...
        private IWidget BuildCardsWidget(ScreenPageNewsJsonData jsonData)
        {

...
namespace DungeonArchitect.Editors.LaunchPad
{
    public class LaunchPadWindow : EditorWindow
    {
        ...
        private class BreadCrumbUserData
        {
        ...
        private PanelWidget pageHost;
        private ScrollPanelWidget pageScroller;
        private ListViewWidget<LaunchPadCategoryData> categoryListView;
        ...
        [System.Serializable]
        private class SidebarDataEntry
        {
            public string page = "";
            public string title = "";
        }
        ...
        [System.Serializable]
        private class SidebarData
        {
            public SidebarDataEntry[] items = new SidebarDataEntry[0];
        }

        private IWidget CreateReviewWidget()
        {
            var color = 0.5f;
        ...
        private IWidget BuildCategoriesListView()
        {
            LoadCategories();
        ...
        private IWidget BuildContentWidget()
        {
        ...
        private void PushPage(string path)
        {
        ...
        private IWidget CreateBrandingWidget()
        {

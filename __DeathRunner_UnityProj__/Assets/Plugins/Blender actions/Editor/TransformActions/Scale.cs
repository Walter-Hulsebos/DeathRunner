...
namespace BlenderActions
{
    public class Scale : BaseTransform
	{
        ...
        public override void Start()
        {
			...
			OriginalMousePos = BA.CurrentEvent.mousePosition * EditorGUIUtility.pixelsPerPoint;
			...
			LastMousePos = BA.CurrentEvent.mousePosition * EditorGUIUtility.pixelsPerPoint;
			...
			Vector2 pivotPosScreenSpace = sceneCam.WorldToScreenPoint(pivot) * EditorGUIUtility.pixelsPerPoint;
			pivotPosScreenSpace.y = sceneCam.pixelHeight * EditorGUIUtility.pixelsPerPoint - pivotPosScreenSpace.y;
        ...
        private void CalculateScale()
		{
			...
			Vector2 upsideDownMousePos = BA.CurrentEvent.mousePosition * EditorGUIUtility.pixelsPerPoint;
			...
			if (!BA.NumericSnap && BA.VertexSnapON_ThisFrame)
			{
				...
				Vector2 correctedMousePos = BA.CurrentEvent.mousePosition * EditorGUIUtility.pixelsPerPoint;
				correctedMousePos.y = sceneCam.pixelHeight * EditorGUIUtility.pixelsPerPoint - correctedMousePos.y;

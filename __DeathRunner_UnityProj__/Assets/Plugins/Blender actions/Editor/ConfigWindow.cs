...
namespace BlenderActions
{
	public class ConfigWindow : EditorWindow
	{
		...
		private void OnGUI()
		{
			...
			else
			{
				...
				EditorGUILayout.LabelField("v. 1.1", s, GUILayout.Height(20));
				...
				EditorGUILayout.BeginVertical();
					...
					if (SavableEditorPrefs.ShowTutorialSectionInCfgWindow)
					{
						...
						if (SavableEditorPrefs.Language == Language.ENG)
							...
							" двох вікон. Щоб це поправити, наведіть курсор миші на вікно 'Scene View' та натисніть праву\n" +
							" кнопку миші.";
						else if (SavableEditorPrefs.Language == Language.RU)
							...
							" окон. Чтобы это поправить, наведите курсор мышки на окно 'Scene View' и нажмите правую\n" +
							" кнопку мышки.";
	...
	public class EnterKey : EditorWindow
	{
		...
		public static EnterKey OpenWindow(ConfigWindow configWindow, bool isMain)
		{
			...
			position.center = new Rect(0f, 0f, Screen.currentResolution.width * EditorGUIUtility.pixelsPerPoint,
				Screen.currentResolution.height * EditorGUIUtility.pixelsPerPoint).center;

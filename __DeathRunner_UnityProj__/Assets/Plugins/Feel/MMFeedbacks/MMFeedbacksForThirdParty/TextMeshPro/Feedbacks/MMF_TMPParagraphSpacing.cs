...
namespace MoreMountains.Feedbacks
{
	...
	public class MMF_TMPParagraphSpacing : MMF_FeedbackBase
	{
		...
		public MMTweenType ParagraphSpacingCurve = new(new AnimationCurve(new Keyframe(0, 0), new Keyframe(0.3f, 1f), new Keyframe(1, 0)));
		...
		protected override void FillTargets()
		{
			...
			MMF_FeedbackBaseTarget target = new();

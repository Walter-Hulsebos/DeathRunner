...
namespace MoreMountains.Feedbacks
{
	...
	public class MMFeedbackPosition : MMFeedback
	{
		...
		public AnimationCurve AnimatePositionCurveX = new(new Keyframe(0, 0), new Keyframe(0.3f, 1f), new Keyframe(0.6f, -1f), new Keyframe(1, 0f));
		...
		public AnimationCurve AnimatePositionCurveY = new(new Keyframe(0, 0), new Keyframe(0.3f, 1f), new Keyframe(0.6f, -1f), new Keyframe(1, 0f));
		...
		public AnimationCurve AnimatePositionCurveZ = new(new Keyframe(0, 0), new Keyframe(0.3f, 1f), new Keyframe(0.6f, -1f), new Keyframe(1, 0f));

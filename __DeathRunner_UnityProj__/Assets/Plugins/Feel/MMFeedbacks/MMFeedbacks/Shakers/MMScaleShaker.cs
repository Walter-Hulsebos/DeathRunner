...
{
	/// <summary>
	/// This shaker will let you move the scale of a transform, either once or permanently, shaking its scale for the specified duration and within the specified range.

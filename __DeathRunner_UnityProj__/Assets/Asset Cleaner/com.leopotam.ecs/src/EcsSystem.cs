...
namespace Leopotam.Ecs {
    ...
    public sealed class EcsSystems : IEcsInitSystem, IEcsDestroySystem, IEcsRunSystem {
        ...
        private readonly EcsGrowList<IEcsSystem> _allSystems = new EcsGrowList<IEcsSystem> (64);
        private readonly EcsGrowList<EcsSystemsRunItem> _runSystems = new EcsGrowList<EcsSystemsRunItem> (64);
        private readonly Dictionary<int, int> _namedRunSystems = new Dictionary<int, int> (64);
        private readonly Dictionary<Type, object> _injections = new Dictionary<Type, object> (32);
        private bool _injected;
#if DEBUG
        private bool _inited;
        private bool _destroyed;
        private readonly List<IEcsSystemsDebugListener> _debugListeners = new List<IEcsSystemsDebugListener> (4);
    ...
    internal sealed class RemoveOneFrame<T> : IEcsRunSystem where T : class {

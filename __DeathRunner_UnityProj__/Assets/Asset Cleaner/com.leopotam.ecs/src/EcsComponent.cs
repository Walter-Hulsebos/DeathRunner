...
#if DEBUG
        private readonly List<System.Reflection.FieldInfo> _nullableFields = new List<System.Reflection.FieldInfo> (8);
#endif

        public object[] Items = new Object[128];

        private Func<object> _customCtor;
        private readonly Type _type;
        private readonly bool _isAutoReset;

        private int[] _reservedItems = new int[128];

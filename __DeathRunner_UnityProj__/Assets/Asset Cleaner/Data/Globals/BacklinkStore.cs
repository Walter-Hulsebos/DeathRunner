...
namespace Asset_Cleaner {
    internal class BacklinkStore {
        ...
        private Dictionary<string, FwMeta> _forward;
        ...
        private void _FillFwAndBacklinks(string path) {
        ...
        private void UpdateFoldersWithQtyByPath(string path) {
            var folders = GetAllFoldersFromPath(path);
        ...
        private static List<string> GetAllFoldersFromPath(string p) {
        ...
        private static string[] _Dependencies(string s) {
            if (s[0] == 'A')

...
namespace Asset_Cleaner {
    internal static class PersistenceUtils {
        ...
        private static AufSerializableData Deserialize() {
        ...
        private static string Path => $"{Application.temporaryCachePath}/AssetCleaner_{AufSerializableData.CurrentVersion}.json";

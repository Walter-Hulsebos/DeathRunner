...
namespace Asset_Cleaner {
    internal class SceneToClose : IEcsAutoReset {
        public Scene Scene;
    ...
    internal class SysSceneCleanup : IEcsRunSystem, IEcsDestroySystem {
        private EcsFilter<SceneToClose> ScenesToClose = default;

...
namespace Asset_Cleaner {
    internal static class ProjectViewGui {
        private static CleanerStyleAsset.Style _style = Globals<WindowData>.Value.Style;
        ...
        private static void ShowRowQuantity(Rect rect, string path, BacklinkStore backlinkStore) {

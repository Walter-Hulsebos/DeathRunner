...
namespace Asset_Cleaner {
    internal class FileResultTag { }

    internal enum TargetTypeEnum {
        File = 0,
        Directory = 1,
        Scene = 2,
        ObjectInScene = 3,
    ...
    internal class SysWindowGui : IEcsRunSystem, IEcsInitSystem {
        private EcsFilter<Result, SearchResultGui, InSceneResult> SceneResultRows = null;
        private EcsFilter<SceneResult, SceneDetails> ScenePaths = null;
        private EcsFilter<SearchArg>.Exclude<InSceneResult> SearchArgMain = null;
        private EcsFilter<Result, SearchResultGui, FileResultTag> FileResultRows = null;
        ...
        private string[] _toolbarStrings = {"Main", "Settings"};

        private const int _progressBarShowFromLevel = 10;
        private int _toolbarSelection = 0;

        private int _settingIgnoredPathsHash1;

        private bool BacklinkStoreDirty(bool set) {
        ...
        private int _settingCodeHash1;

        private bool VisualSettingDirty(bool set) {
        ...
        private void ShowTabSettings(Config conf) {
        ...
        private void ShowTabMain(Config conf, WindowData windowData) {
        ...
        private static bool TryGetHelpInfo(SearchArg arg, out string msg, out MessageType msgType) {
        ...
        private static TargetTypeEnum GetTargetType(WindowData windowData1, Object obj) {
        ...
        private GUIContent _contentBuf = new GUIContent();
        private GUIContent _buf2 = new GUIContent();

        private BacklinkStore.UnusedQty ShowObjectName(BacklinkStore store, WindowData windowData, TargetTypeEnum targetTypeEnum, SearchArg arg, string[] selectedGuids) {
            float TextWidth() {
        ...
        private static bool AskDeleteUnusedFiles(SearchArg arg, List<string> unusedAssets, WindowData windowData) {
        ...
        private static bool AskDeleteUnusedScenes(SearchArg arg, List<string> unusedScenes, WindowData windowData) {
        ...
        private void RenderRows(WindowData windowData) {
        ...
        private class ResultComp : IEqualityComparer<Result> {
        ...
        private static void DrawRowScene(SearchResultGui gui) {
        ...
        private static void DrawRowFile(Result data, SearchResultGui gui, WindowData windowData) {
            using (new EditorGUILayout.VerticalScope(EditorStyles.helpBox)) {
                var buf = GUI.color;
